...
! function (e, t) {
    ...
    r(l, [], function () {
        ...
        function C() {}
        var x, w, _, N, E, k, S, T, R, A, B, D, L, M, H, P, O, I = "sizzle" + -new Date,
            F = window.document,
            z = {},
            W = 0,
            V = 0,
        ...
        function g(e, n, r) {
            for (var i = [], o = e[n]; o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !f(o).is(r));) 1 === o.nodeType && i.push(o), o = o[n];
            return i
        }
        ...
        var b = document,
            ...
            w = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
            _ = e.Event,
            N, E = r.makeMap("fillOpacity fontWeight lineHeight opacity orphans widows zIndex zoom", " "),
            k = r.makeMap("checked compact declare defer disabled ismap multiple nohref noshade nowrap readonly selected", " "),
            S = {
                "for": "htmlFor",
                "class": "className",
                readonly: "readOnly"
        ...
        return f.fn = f.prototype = {
            ...
            init: function (e, t) {
                ...
                if (t && t.nodeType) n.context = t;
                    ...
                    if (n.selector = e, r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : w.exec(e), !r) return f(t).find(e);
                    if (r[1])
                        for (i = s(e, t).firstChild; i;) C.call(n, i), i = i.nextSibling;
                    else {
            ...
            remove: function () {
                for (var e = this, t, n = this.length; n--;) t = e[n], _.clean(t), t.parentNode && t.parentNode.removeChild(t);
                return this
            },
            empty: function () {
            ...
            f.fn[e] = function (n) {
                ...
                }), i = f.unique(i), (0 === e.indexOf("parents") || "prevUntil" === e) && (i = i.reverse()), i = f(i), n && -1 == e.indexOf("Until") ? i.filter(n) : i
            }
        }), f.fn.is = function (e) {
        ...
        function d(e, t) {
            var o = this,
                a;
            o.doc = e, o.win = window, o.files = {}, o.counter = 0, o.stdMode = !y || e.documentMode >= 8, o.boxModel = !y || "CSS1Compat" == e.compatMode || o.stdMode, o.hasOuterHTML = "outerHTML" in e.createElement("a"), o.styleSheetLoader = new u(e), this.boundEvents = [], o.settings = t = g({
                keep_values: !1,
                hex_colors: 1
            }, t), o.schema = t.schema, o.styles = new r({
                url_converter: t.url_converter,
                url_converter_scope: t.url_converter_scope
            }, t.schema), o.fixDoc(e), o.events = t.ownEvents ? new i(t.proxy) : i.Event, a = t.schema ? t.schema.getBlockElements() : {}, o.$ = n.overrideDefaults(function () {
                return {
                    context: e,
                    element: o.getRoot()
                }
        ...
        return d.prototype = {
            ...
            clone: function (e, t) {
                var n = this,
                    r, i;
                return !y || 1 !== e.nodeType || t ? e.cloneNode(t) : (i = n.doc, t ? r.firstChild : (r = i.createElement(e.nodeName), f(n.getAttribs(e), function (t) {
            ...
            remove: function (e, t) {
                return this.run(e, function (e) {
                    ...
                    if (!r) return null;
                    if (t)
                        for (; n = e.firstChild;)!y || 3 !== n.nodeType || n.nodeValue ? r.insertBefore(n, e) : e.removeChild(n);
                    ...
                    if (t)
                        if ("string" == typeof t) {
                            i = e.style, t = t.replace(/-(\D)/g, function (e, t) {
                                return t.toUpperCase()
                            }), "number" != typeof n && !/^[\-0-9\.]+$/.test(n) || x[t] || (n += "px"), "opacity" === t && e.runtimeStyle && "undefined" == typeof e.runtimeStyle.opacity && (i.filter = "" === n ? "" : "alpha(opacity=" + 100 * n + ")"), "float" == t && (t = "cssFloat" in e.style ? "cssFloat" : "styleFloat");
                            try {
                                i[t] = n
                            } catch (a) {}
            ...
            setAttrib: function (e, t, n) {
                ...
                if (e && t) return this.run(e, function (e) {
                    ...
                    p(n) && null !== n && 0 !== n.length ? e.setAttribute(t, "" + n, 2) : e.removeAttribute(t, 2), o != n && i.onSetAttrib && i.onSetAttrib({
                        attrElm: e,
                        attrName: t,
                        attrValue: n
                    })
            ...
            getAttrib: function (e, t, n) {
                ...
                if (y && i.props[t] && (r = e[i.props[t]], r = r && r.nodeValue ? r.nodeValue : r), r || (r = e.getAttribute(t, 2)), /^(checked|compact|declare|defer|disabled|ismap|multiple|nohref|noshade|nowrap|readonly|selected)$/.test(t)) return e[i.props[t]] === !0 && "" === r ? t : r ? t : "";
                if ("FORM" === e.nodeName && e.getAttributeNode(t)) return e.getAttributeNode(t).nodeValue;
                if ("style" === t && (r = r || e.style.cssText, r && (r = i.serializeStyle(i.parseStyle(r), e.nodeName), i.settings.keep_values && e.setAttribute("data-mce-style", r))), v && "class" === t && r && (r = r.replace(/(apple|webkit)\-[a-z\-]+/gi, "")), y) switch (t) {
                case "rowspan":
                case "colspan":
                    1 === r && (r = "");
                    break;
            ...
            loadCSS: function (e) {
                var t = this,
                    n = t.doc,
                    r;
                return t !== d.DOM && n === document ? void d.DOM.loadCSS(e) : (e || (e = ""), r = n.getElementsByTagName("head")[0], void f(e.split(","), function (e) {
                    var i;
            ...
            setOuterHTML: function (e, t, n) {
                ...
                return r.run(e, function (e) {
                    ...
                    if (1 == e.nodeType)
                        if (n = n || e.ownerDocument || r.doc, y) try {
            ...
            run: function (e, t, n) {
                var r = this,
                    i;
                return "string" == typeof e && (e = r.get(e)), e ? (n = n || this, e.nodeType || !e.length && 0 !== e.length ? t.call(n, e) : (i = [], f(e, function (e, o) {
        ...
        return function (e) {
            ...
            function f(e) {
                var n, r, i, a, s, l, u, f, p, h, m, g, v, b, x, w, _, N, E, k = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                    S = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
                    T = /[*?+]/;
                if (e)
                        ...
                        if (s = k.exec(e[n])) {
                            ...
                            if (f)
                                for (f = t(f, "|"), i = 0, a = f.length; a > i; i++)
                                    if (s = S.exec(f[i])) {
                                        if (u = {}, m = s[1], h = s[2].replace(/::/g, ":"), b = s[3], E = s[4], "!" === m && (l.attributesRequired = l.attributesRequired || [], l.attributesRequired.push(h), u.required = !0), "-" === m) {
                                        ...
                                        b && ("=" === b && (l.attributesDefault = l.attributesDefault || [], l.attributesDefault.push({
                                            ...
                                            name: h,
                                            value: E
                                        }), u.forcedValue = E), "<" === b && (u.validValues = o(E, "?"))), T.test(h) ? (l.attributePatterns = l.attributePatterns || [], u.pattern = d(h), l.attributePatterns.push(u)) : (g[h] || v.push(h), g[h] = u)
                                    }
        ...
        function r(e, t, n) {
            var r = 1,
                i, o, a, s;
            for (s = e.getShortEndedElements(), a = /<([!?\/])?([A-Za-z0-9\-\:\.]+)((?:\s+[^"\'>]+(?:(?:"[^"]*")|(?:\'[^\']*\')|[^>]*))*|\/|\s+)>/g, a.lastIndex = i = n; o = a.exec(t);) {
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this,
                    c, u = 0,
                    d, f, p = [],
                    h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, D, L, M, H, P, O, I, F = 0,
                    z = t.decode,
                    W, V = n.makeMap("src,href,data,background,formaction,poster"),
                    U = /((java|vb)script|mhtml):/i,
                    q = /^data:/i;
                for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), P = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), M = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), _ = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = H.exec(e);) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6]) d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d);
                    else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && M[d] && p.length > 0 && p[p.length - 1].name === d && o(d), !_ || (N = a.getElementRule(d))) {
                            if (E = !0, _ && (T = N.attributes, R = N.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (E = !1), h = [], h.map = {}, S.replace(P, s)) : (h = [], h.map = {}), _ && !y) {
                                if (A = N.attributesRequired, B = N.attributesDefault, D = N.attributesForced, L = N.removeEmptyAttrs, L && !h.length && (E = !1), D)
                                ...
                                if (A) {
                                    for (m = A.length; m-- && !(A[m] in h.map);); - 1 === m && (E = !1)
                                }
        ...
        return function (r, i) {
            ...
            function a(t) {
                ...
                n = t.screenX - T, r = t.screenY - R, P = n * k[2] + D, O = r * k[3] + L, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && k[2] * k[3] !== 0, o && (W(n) > W(r) ? (O = V(P * M), P = V(O / M)) : (P = V(O / M), O = V(P * M))), C.setStyles(_, {
                    width: P,
                    height: O
                }), a = k.startPos.x + n, s = k.startPos.y + r, a = a > 0 ? a : 0, s = s > 0 ? s : 0, C.setStyles(N, {
                    left: a,
                    top: s,
                    display: "block"
                }), N.innerHTML = P + " &times; " + O, k[2] < 0 && _.clientWidth <= P && C.setStyle(_, "left", A + (D - P)), k[3] < 0 && _.clientHeight <= O && C.setStyle(_, "top", B + (L - O)), n = U.scrollWidth - q, r = U.scrollHeight - $, n + r !== 0 && C.setStyles(N, {
                    left: a - n,
                    top: s - r
            ...
            function s() {
                ...
                H = !1, e("width", P), e("height", O), C.unbind(I, "mousemove", a), C.unbind(I, "mouseup", s), F != I && (C.unbind(F, "mousemove", a), C.unbind(F, "mouseup", s)), C.remove(_), C.remove(N), z && "TABLE" != w.nodeName || l(w), i.fire("ObjectResized", {
                    target: w,
                    width: P,
                    height: O
                }), i.nodeChanged()
            ...
            function l(e, t, r) {
                ...
                g(), l = C.getPos(e, U), A = l.x, B = l.y, p = e.getBoundingClientRect(), u = p.width || p.right - p.left, d = p.height || p.bottom - p.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {
                    ...
                    function o(t) {
                        T = t.screenX, R = t.screenY, D = w.clientWidth, L = w.clientHeight, M = L / D, k = e, e.startPos = C.getPos(e.elm, U), q = U.scrollWidth, $ = U.scrollHeight, _ = w.cloneNode(!0), C.addClass(_, "mce-clonedresizable"), C.setAttrib(_, "data-mce-bogus", "all"), _.contentEditable = !1, _.unSelectabe = !0, C.setStyles(_, {
                            left: A,
                            top: B,
                            margin: 0
                        }), _.removeAttribute("data-mce-selected"), U.appendChild(_), C.bind(I, "mousemove", a), C.bind(I, "mouseup", s), F != I && (C.bind(F, "mousemove", a), C.bind(F, "mouseup", s)), N = C.add(U, "div", {
            ...
            function u(e) {
                ...
                }), n = "mousedown" == e.type ? e.target : r.getNode(), n = C.getParent(n, z ? "table" : "table,img,hr"), t(n, U) && (v(), t(r.getStart(), n) && t(r.getEnd(), n) && (!z || n != r.getStart() && "IMG" !== r.getStart().nodeName)) ? void l(n) : void c()
            }
            ...
            function p(e) {
                ...
                for (r in E)
                    if (o = E[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], W(a - c) < 8 && W(s - u) < 8) {
                        k = o;
                        break
                    }
            ...
            var C = i.dom,
                x = t.each,
                w, _, N, E, k, S, T, R, A, B, D, L, M, H, P, O, I = i.getDoc(),
                F = document,
                z = n.ie && n.ie < 11,
                W = Math.abs,
                V = Math.round,
        ...
        return function (a) {
            ...
            function g(t, n, r) {
                ...
                function u(e, r, o) {
                    ...
                    u = p.inline || p.block, f = W.create(u), i(f), U.walk(e, function (e) {
                        function m(e) {
                            var v, C, x, w, _;
                            return _ = h, v = e.nodeName.toLowerCase(), C = e.parentNode.nodeName.toLowerCase(), 1 === e.nodeType && et(e) && (_ = h, h = "true" === et(e), w = !0), k(v, "br") ? (g = 0, void(p.block && W.remove(e))) : p.wrapper && b(e, t, n) ? void(g = 0) : h && !w && p.block && !p.wrapper && s(v) && q(C, u) ? (e = W.rename(e, u), i(e), a.push(e), void(g = 0)) : p.selector && (it(d, function (t) {
                                "collapsed" in t && t.collapsed !== y || W.is(e, t.selector) && !c(e) && (i(e, t), x = !0)
                            }), !p.inline || x) ? void(g = 0) : void(!h || w || !q(u, v) || !q(C, u) || !o && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || c(e) || p.inline && $(e) ? "li" == v && r ? g = l(e, r, f, a, m) : (g = 0, it(ot(e.childNodes), m), w && (h = _), g = 0) : (g || (g = W.clone(f, X), e.parentNode.insertBefore(g, e), a.push(g)), g.appendChild(e)))
                        }
                        var g;
                        it(e, m)
                ...
                var d = f(t),
                    p = d[0],
                    h, v, y = !r && V.isCollapsed();
                if (p)
                    if (r) r.nodeType ? (v = W.createRng(), v.setStartBefore(r), v.setEndAfter(r), u(D(v, d), null, !0)) : u(r, null, !0);
                    else if (y && p.inline && !W.select("td.mce-item-selected,th.mce-item-selected").length) I("apply", t, n);
                else {
                    var C = a.selection.getNode();
                    j || !d[0].defaultBlock || W.getParent(C, W.isBlock) || g(d[0].defaultBlock), a.selection.setRng(o()), h = V.getBookmark(), u(D(V.getRng(J), d), h), p.styles && (p.styles.color || p.styles.textDecoration) && (at(C, m, "childNodes"), m(C)), V.moveToBookmark(h), F(V.getRng(J)), a.nodeChanged()
                }
            }
            ...
            function v(e, t, n, r) {
                ...
                function s(e, n, r, i) {
                    ...
                    if (e) {
                        ...
                        }!i || m.mixed && $(e) || (n = W.split(e, n)), s && (r.parentNode.insertBefore(s, r), l.appendChild(r))
                    }
                    return n
                }
            ...
            function b(e, t, n, r) {
                ...
                if (o && e)
                    for (s = 0; s < o.length; s++)
                        if (a = o[s], E(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
                            if (l = a.classes)
            ...
            function I(t, n, r, i) {
                ...
                function d(e, t) {
                    var n, r;
                    if (e) r = V.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), W.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === G && (n.deleteData(0, 1), r.startContainer == n && r.startOffset--, r.endContainer == n && r.endOffset--), W.remove(e, 1)), V.setRng(r);
                ...
                function p() {
                    var e, t, i, a, s, l, d;
                    e = V.getRng(!0), a = e.startOffset, l = e.startContainer, d = l.nodeValue, t = c(V.getStart()), t && (i = u(t)), d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1)) ? (s = V.getBookmark(), e.collapse(!0), e = D(e, f(n)), e = U.split(e), g(n, r, e), V.moveToBookmark(s)) : (t && i.nodeValue === G ? g(n, r, t) : (t = o(!0), i = t.firstChild, e.insertNode(t), a = 1, g(n, r, t)), V.setCursorLocation(i, a))
                }
            ...
            function F(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = K(n), n = n.parentNode, i = !0), 1 == n.nodeType)
                    for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, W.getParent(n, W.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())
                        if (3 == a.nodeType && !A(a)) return l = W.create("a", null, G), a.parentNode.insertBefore(l, a), t.setStart(a, 0), V.setRng(t), void W.remove(l)
            }
            var z = {},
                W = a.dom,
                V = a.selection,
            ...
            function o(o) {
                ...
                function b(e, t) {
                    ...
                    if (r = a.getParent(e, a.isBlock), c = i.getBody().nodeName.toLowerCase(), !r || !f(r)) {
                        if (r = r || S, !r.hasChildNodes()) return n = a.create(d), g(n), r.appendChild(n), E.setStart(n, 0), E.setEnd(n, 0), n;
                ...
                function C() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (I = "LI"), L = I ? v(I) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(L, t()) : a.replace(L, H) : e(!0) ? "LI" == n ? (a.insertAfter(L, t()), L.appendChild(a.doc.createTextNode(" ")), L.appendChild(H)) : H.parentNode.insertBefore(L, H) : e() ? (a.insertAfter(L, t()), p(L)) : (H = t(), k = E.cloneRange(), k.setStartAfter(A), k.setEndAfter(H), M = k.extractContents(), "LI" == I && "LI" == M.firstChild.nodeName ? (L = M.firstChild, a.insertAfter(M, H)) : (a.insertAfter(M, H), a.insertAfter(L, H))), a.remove(A), m(L), c.add()
                }
                ...
                if (E = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(E), T = E.startContainer, R = E.startOffset, I = (l.force_p_newlines ? "p" : "") || l.forced_root_block, I = I ? I.toUpperCase() : "", B = a.doc.documentMode, D = o.shiftKey, 1 == T.nodeType && T.hasChildNodes() && (F = R > T.childNodes.length - 1, T = T.childNodes[Math.min(R, T.childNodes.length - 1)] || T, R = F && 3 == T.nodeType ? T.nodeValue.length : 0), S = _(T)) {
                        if (c.beforeChange(), !a.isBlock(S) && S != a.getRoot()) return void((!I || D) && x());
                        if ((I && !D || !I && D) && (T = b(T, R)), A = a.getParent(T, a.isBlock), H = A ? a.getParent(A.parentNode, a.isBlock) : null, P = A ? A.nodeName.toUpperCase() : "", O = H ? H.nodeName.toUpperCase() : "", "LI" != O || o.ctrlKey || (A = H, P = O), /^(LI|DT|DD)$/.test(P)) {
        ...
        return function (r) {
            ...
            l(this, {
                ...
                "InsertUnorderedList,InsertOrderedList": function (e) {
                    var t, n;
                    x(e), t = k.getParent(S.getNode(), "ol,ul"), t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (N(), k.split(n, t), E()))
                },
                ...
                mceInsertContent: function (t, n, o) {
                    ...
                    var N = y.startContainer || (y.parentElement ? y.parentElement() : null),
                        E = r.getBody();
                    N === E && S.isCollapsed() && k.isBlock(E.firstChild) && k.isEmpty(E.firstChild) && (y = k.createRng(), y.setStart(E.firstChild, 0), y.setEnd(E.firstChild, 0), S.setRng(y)), S.isCollapsed() || r.getDoc().execCommand("Delete", !1, null), f = S.getNode();
                    var T = {
        ...
        return function (a) {
            ...
            var W = o.each,
                ...
                X = i.ie,
                J = i.webkit;
            _(), d(), D(), J && (u(), p(), g(), k(), z(), C(), i.iOS ? (y(), M(), H(), F()) : f()), X && i.ie < 11 && (h(), b(), x(), w(), T(), R(), A(), B()), i.ie >= 11 && (H(), I(), C()), i.ie && (f(), O()), Y && (h(), m(), v(), N(), E(), S(), L(), P(), C())
        }
    }), r(st, [U], function (e) {
        function t(t) {
        ...
        function N(e, t, i) {
            ...
            a = o.documentBaseUrl = i.documentBaseURL, s = i.baseURI, o.settings = t = T({
                ...
                base_uri: s
            }), o.baseURI = s, o.contentCSS = [], o.contentStyles = [], o.shortcuts = new _(o), o.execCommands = {}, o.queryStateCommands = {}, o.queryValueCommands = {}, o.loadedCSS = {}, o.suffix = i.suffix, o.editorManager = i, o.inline = t.inline, i.fire("SetupEditor", o), o.execCallback("setup", o), o.$ = n.overrideDefaults(function () {
                return {
        ...
        return N.prototype = {
            ...
            initContentBody: function (t) {
                ...
                r.inline || (n.getElement().style.visibility = n.orgVisibility), t || r.content_editable || (p.open(), p.write(n.iframeHTML), p.close()), r.content_editable && (n.on("remove", function () {
                    ...
                    for (var t = e.length, r, o = n.schema.getNonEmptyElements(); t--;) r = e[t], r.isEmpty(o) && (r.empty().append(new i("br", 1)).shortEnded = !0)
                }), n.serializer = new o(r, n), n.selection = new s(n.dom, n.getWin(), n.serializer, n), n.formatter = new l(n), n.undoManager = new c(n), n.forceBlocks = new d(n), n.enterKey = new u(n), n.editorCommands = new f(n), n.fire("PreInit"), r.browser_spellcheck || r.gecko_spellcheck || (p.body.spellcheck = !1, E.setAttrib(h, "spellcheck", "false")), n.fire("PostRender"), n.quirks = b(n), r.directionality && (h.dir = r.directionality), r.nowrap && (h.style.whiteSpace = "nowrap"), r.protect && n.on("BeforeSetContent", function (e) {
            ...
            focus: function (e) {
                var t, n = this,
                    ...
                    l;
                if (!e) {
                    if (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || (C.opera || n.getBody().focus(), n.getWin().focus()), H || i) {
            ...
            nodeChanged: function (e) {
                var t = this,
                    n = t.selection,
                    r, i, o;
                !t.initialized || t.settings.disable_nodechange || t.settings.readonly || (o = t.getBody(), r = n.getStart() || o, r = P && r.ownerDocument != t.getDoc() ? t.getBody() : r, "IMG" == r.nodeName && n.isCollapsed() && (r = r.parentNode), i = [], t.dom.getParent(r, function (e) {
            ...
            execCommand: function (e, t, n, r) {
                var i = this,
                    o = 0,
                    a;
                if (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(e) || r && r.skip_focus || i.focus(), r = T({}, r), r = i.fire("BeforeExecCommand", {
                    command: e,
                    ui: t,
                    value: n
            ...
            hide: function () {
                var e = this,
                    t = e.getDoc();
                e.hidden || (P && t && !e.inline && t.execCommand("SelectAll"), e.save(), e.inline ? (e.getBody().contentEditable = !1, e == e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (E.hide(e.getContainer()), E.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.fire("hide"))
            },
            isHidden: function () {
                return !!this.hidden
            },
            ...
            remove: function () {
                var e = this;
                if (!e.removed) {
                    e.save(), e.removed = 1, e.hasHiddenInput && E.remove(e.getElement().nextSibling), e.inline || (P && 10 > P && e.getDoc().execCommand("SelectAll", !1, null), E.setStyle(e.id, "display", e.orgDisplay), e.getBody().onload = null, M.unbind(e.getWin()), M.unbind(e.getDoc()));
            ...
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    for (h = g.top, f = 0; n > f; f++) {
                        for (p = g.left, s = E[f] + D, d = 0; r > d && (B = A ? f * r + r - 1 - d : f * r + d, u = i[B], u); d++) m = u.settings, c = u.layoutRect(), a = Math.max(N[d], c.startMinWidth), c.x = p, c.y = h, v = m.alignH || (C ? C[d] || C[0] : null), "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = m.alignV || (x ? x[d] || x[0] : null), "center" == v ? c.y = h + s / 2 - c.h / 2 : "bottom" == v ? c.y = h + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), p += a + y, u.recalc && u.recalc();
                        h += s + b
                    }
...
tinymce.PluginManager.add("anchor", function (n) {
    function e() {
        ...
        n.windowManager.open({
            ...
            onsubmit: function (e) {
                n.execCommand("mceInsertContent", !1, n.dom.createHTML("a", {
                    id: e.data.name
                }))
            }
        })
...
tinymce.PluginManager.add("autosave", function (e) {
    ...
    function o() {
        n() && (e.setContent(l.getItem(d + "draft"), {
            format: "raw"
        }), e.fire("RestoreDraft"))
    }
    ...
    var d, m, v = e.settings,
        l = tinymce.util.LocalStorage;
...
tinymce.PluginManager.add("code", function (e) {
    function o() {
        ...
        o.find("#code").value(e.getContent({
            source_view: !0
        }))
    }
...
tinymce.PluginManager.add("colorpicker", function (e) {
    function n(n, a) {
        function i(e) {
            var n = new tinymce.util.Color(e),
                a = n.toRgb();
            l.fromJSON({
                r: a.r,
                g: a.g,
                b: a.b,
                hex: n.toHex().substr(1)
            }), t(n.toHex())
        }
...
tinymce.PluginManager.add("contextmenu", function (e) {
    ...
    e.on("contextmenu", function (i) {
        var o;
        if (!i.ctrlKey || t) {
            if (i.preventDefault(), o = e.settings.contextmenu || "link image inserttable | cell row column deletetable", n) n.show();
            else {
                var c = [];
...
tinymce.PluginManager.add("directionality", function (t) {
    function e(e) {
        var i, n = t.dom,
            r = t.selection.getSelectedBlocks();
...
tinymce.PluginManager.add("fullpage", function (e) {
    ...
    function l(t) {
        ...
        a = i(), r = a.getAll("head")[0], r || (c = a.getAll("html")[0], r = new m("head", 1), c.firstChild ? c.insert(r, c.firstChild, !0) : c.append(r)), c = a.firstChild, t.xml_pi ? (u = 'version="1.0"', t.docencoding && (u += ' encoding="' + t.docencoding + '"'), 7 != c.type && (c = new m("xml", 7), a.insert(c, a.firstChild, !0)), c.value = u) : c && 7 == c.type && c.remove(), c = a.getAll("#doctype")[0], t.doctype ? (c || (c = new m("#doctype", 10), t.xml_pi ? a.insert(c, a.firstChild) : l(c)), c.value = t.doctype.substring(9, t.doctype.length - 1)) : c && c.remove(), c = null, s(a.getAll("meta"), function (e) {
            ...
            var n, i, r = a.getAll("meta"),
                o = t[e];
            for (n = 0; n < r.length; n++)
                if (i = r[n], i.attr("name") == e) return void(o ? i.attr("content", o) : i.remove());
    ...
    function a(t) {
        ...
        if (!t.selection && !("raw" == t.format && d || t.source_view && e.getParam("fullpage_hide_in_source_view"))) {
            ...
            f && (g.add(y, "style", {
                id: "fullpage_styles"
            }, f), m = g.get("fullpage_styles"), m.styleSheet && (m.styleSheet.cssText = f));
            var h = {};
...
tinymce.PluginManager.add("importcss", function (t) {
    ...
    function i(e) {
        ...
        if (i) {
            var r = i[1],
                s = i[2].substr(1).split(".").join(" "),
                c = tinymce.makeMap("a,img");
            return i[1] ? (n = {
                title: e
            }, t.schema.getTextBlockElements()[r] ? n.block = r : t.schema.getBlockElements()[r] || c[r.toLowerCase()] ? n.selector = r : n.inline = r) : i[2] && (n = {
                inline: "span",
                title: e.substr(1),
                classes: s
            }), t.settings.importcss_merge_classes !== !1 ? n.classes = s : n.attributes = {
                "class": s
            }, n
        }
    }
    ...
    t.on("renderFormatsMenu", function (c) {
        var o = t.settings,
            a = {},
            l = o.importcss_selector_converter || i,
            f = e(o.importcss_selector_filter),
            m = c.control;
        ...
        tinymce.each(o.importcss_groups, function (t) {
            ...
            if (-1 === e.indexOf(".mce-") && !a[e] && (!f || f(e))) {
                ...
                if (i) {
                    ...
                    var o = tinymce.extend({}, m.settings.itemDefaults, {
                        text: i.title,
                        format: s
                    });
                    n ? n.push(o) : m.add(o)
...
tinymce.PluginManager.add("insertdatetime", function (e) {
    ...
    var n, r, i = "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "),
...
! function (e) {
    e.on("AddEditor", function (e) {
        ...
        t.on("init", function () {
            var i = "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img",
                n = e.explode(t.settings.font_size_style_values),
                l = t.schema;
...
tinymce.PluginManager.add("lists", function (e) {
    ...
    e.on("init", function () {
        function i(e) {
            function t(t) {
                var r, a, o;
                a = e[t ? "startContainer" : "endContainer"], o = e[t ? "startOffset" : "endOffset"], 1 == a.nodeType && (r = y.create("span", {
                    "data-mce-type": "bookmark"
                }), a.hasChildNodes() ? (o = Math.min(o, a.childNodes.length - 1), t ? a.insertBefore(r, a.childNodes[o]) : y.insertAfter(r, a.childNodes[o])) : a.appendChild(r), a = r, o = 0), n[t ? "startContainer" : "endContainer"] = a, n[t ? "startOffset" : "endOffset"] = o
            }
            var n = {};
        ...
        function s(t, n) {
            var r, a, o, i = y.createFragment(),
                d = e.schema.getBlockElements();
            if (e.settings.forced_root_block && (n = n || e.settings.forced_root_block), n && (a = y.create(n), a.tagName === e.settings.forced_root_block && y.setAttribs(a, e.settings.forced_root_block_attrs), i.appendChild(a)), t)
                for (; r = t.firstChild;) {
                    var s = r.nodeName;
            ...
            return e.settings.forced_root_block ? o || tinymce.Env.ie && !(tinymce.Env.ie > 10) || a.appendChild(y.create("br", {
                "data-mce-bogus": "1"
            })) : i.appendChild(y.create("br")), i
        }
        ...
        function v() {
            var t = f();
            if (t.length) {
                var n, r, a = i(k.getRng(!0)),
                    o = e.getBody();
                for (n = t.length; n--;)
                    for (var s = t[n].parentNode; s && s != o;) {
                        for (r = t.length; r--;)
                            if (t[r] === s) {
                                t.splice(n, 1);
                                break
        ...
        o.backspaceDelete = function (e) {
            function n(e, t) {
                ...
                for (var a = new tinymce.dom.TreeWalker(e.startContainer); n = a[t ? "next" : "prev"]();)
...
tinymce.PluginManager.add("media", function (e, t) {
    ...
    function o() {
        ...
        e.settings.media_alt_source !== !1 && l.push({
            name: "source2",
            type: "filepicker",
            filetype: "media",
            size: 40,
        ...
        }), e.settings.media_poster !== !1 && l.push({
            name: "poster",
            type: "filepicker",
            filetype: "image",
            maxWidth:130,
            size: 40,
            label: "Poster"
        }), e.settings.media_dimensions !== !1 && l.push({
            type: "container",
            label: "Dimensions",
            maxWidth:150,
            layout: "flex",
        ...
        h[d] = i, r = e.windowManager.open({
            title: "Insert/Edit Audio or Video",
            data: u,
            width: 310,
            height:250,
            bodyType: "tabpanel",
            ...
            onSubmit: function () {
                var t, i, r, o;
                for (t = e.dom.select("img[data-mce-object]"), e.insertContent(c(this.toJSON())), i = e.dom.select("img[data-mce-object]"), r = 0; r < t.length; r++)
                    for (o = i.length - 1; o >= 0; o--) t[r] == i[o] && i.splice(o, 1);
    ...
    function s(t) {
        return t.getAttribute("data-mce-object") ? n(e.serializer.serialize(t, {
            selection: !0
        })) : {}
    }
    ...
    function m(e, t, i) {
        function r(e, t) {
            ...
            for (i in t)
                if (o = "" + t[i], e.map[i])
                    for (r = e.length; r--;) a = e[r], a.name == i && (o ? (e.map[i] = o, a.value = o) : (delete e.map[i], e.splice(r, 1)));
                else o && (e.push({
                    name: i,
                    value: o
                }), e.map[i] = o)
        }
        var o, a = new tinymce.html.Writer,
            c = 0;
        return new tinymce.html.SaxParser({
            validate: !1,
            allow_conditional_comments: !0,
    ...
    var u = [{
        ...
        d = tinymce.Env.ie && tinymce.Env.ie <= 8 ? "onChange" : "onInput";
    e.on("ResolveName", function (e) {
        ...
        tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
            ...
            for (var o, a, c, n, s, m, u, d, l = t.length; l--;)
            ...
            for (var i, r, o, a, c, n, s, m = e.length; m--;)
                if (i = e[m], i.parent) {
...
tinymce.PluginManager.add("noneditable", function (e) {
    ...
    function r() {
        ...
        function a(e) {
            var t;
            if (e)
                for (t = new f(e, e), e = t.current(); e; e = t.next())
                    if (3 === e.nodeType) return e
        }
        ...
        function o(e) {
            var t, n, i, o;
            if (e) t = s.getRng(!0), t.setStartBefore(e), t.setEndBefore(e), n = a(e), n && n.nodeValue.charAt(0) == m && (n = n.deleteData(0, 1)), u.remove(e, !0), s.setRng(t);
            else
                for (i = r(s.getStart());
                    (e = u.get(g)) && e !== o;) i !== e && (n = a(e), n && n.nodeValue.charAt(0) == m && (n = n.deleteData(0, 1)), u.remove(e, !0)), o = e
        }
        ...
        function d(a) {
            function i(e, t) {
                for (; e = e[t ? "previousSibling" : "nextSibling"];)
                    if (3 !== e.nodeType || e.nodeValue.length > 0) return e
            }
            ...
            function g(a) {
                ...
                function o() {
                    ...
                    for (o = new tinymce.dom.TreeWalker(d, e.getBody());
                        (r = a ? o.prev() : o.next()) && !l[r.nodeName.toLowerCase()] && !(3 === r.nodeType && tinymce.trim(r.nodeValue).length > 0);)
                        if ("false" === t(r)) return i(r), !0;
                    return n(r) ? !0 : !1
                }
                var f, d, c, g;
                if (s.isCollapsed()) {
            ...
            if (v = s.getStart(), E = s.getEnd(), m = n(v) || n(E), m && (112 > h || h > 124) && h != c.DELETE && h != c.BACKSPACE) {
                ...
                if (a.preventDefault(), h == c.LEFT || h == c.RIGHT) {
                    var y = h == c.LEFT;
                    if (e.dom.isBlock(m)) {
                        var T = y ? m.previousSibling : m.nextSibling,
                            C = new f(T, T),
                            b = y ? C.prev() : C.next();
                        d(b, !y)
                    } else d(m, y)
                ...
                if (p = r(v)) {
                    if (h == c.LEFT || h == c.BACKSPACE)
                        if (m = i(p, !0), m && "false" === t(m)) {
                            if (a.preventDefault(), h != c.LEFT) return void u.remove(m);
                            d(m, !0)
                        } else o(p);
                    if (h == c.RIGHT || h == c.DELETE)
                        if (m = i(p), m && "false" === t(m)) {
    ...
    var i, o, l, f = tinymce.dom.TreeWalker,
        d = "contenteditable",
        u = "data-mce-" + d,
        c = tinymce.util.VK;
...
tinymce.PluginManager.add("pagebreak", function (e) {
    var a = "mce-pagebreak",
        ...
        n = new RegExp(t.replace(/[\?\.\*\[\]\(\)\{\}\+\^\$\:]/g, function (e) {
            return "\\" + e
        }), "gi"),
    ...
    e.addCommand("mcePageBreak", function () {
        ...
        e.serializer.addNodeFilter("img", function (a) {
            for (var n, r, c = a.length; c--;)
                if (n = a[c], r = n.attr("class"), r && -1 !== r.indexOf("mce-pagebreak")) {
                    var o = n.parent;
...
! function (e, t) {
    ...
    var s = {},
        l = "tinymce/pasteplugin/Utils",
        c = "tinymce/util/Tools",
        d = "tinymce/html/DomParser",
        u = "tinymce/html/Schema",
        f = "tinymce/pasteplugin/Clipboard",
        p = "tinymce/Env",
        m = "tinymce/util/VK",
        h = "tinymce/pasteplugin/WordFilter",
        g = "tinymce/html/Serializer",
        v = "tinymce/html/Node",
        y = "tinymce/pasteplugin/Quirks",
        b = "tinymce/pasteplugin/Plugin",
        C = "tinymce/PluginManager";
    r(l, [c, d, u], function (e, t, n) {
        ...
        function i(r) {
            ...
            var o = new n,
                a = new t({}, o),
                s = "",
                l = o.getShortEndedElements(),
                c = e.makeMap("script noscript style textarea video audio iframe object", " "),
                d = o.getBlockElements();
        ...
        return function (r) {
            function i(e) {
                var t, n = r.dom;
                if (t = r.fire("BeforePastePreProcess", {
                    content: e
                }), t = r.fire("PastePreProcess", t), e = t.content, !t.isDefaultPrevented()) {
                    if (r.hasEventListeners("PastePostProcess") && !t.isDefaultPrevented()) {
                        var i = n.add(r.getBody(), "div", {
                            style: "display:none"
                        }, e);
                        t = r.fire("PastePostProcess", {
                            node: i
                        }), n.remove(i), e = t.node.innerHTML
                    }
                    t.isDefaultPrevented() || r.insertContent(e, {
                        merge: r.settings.paste_merge_formats !== !1
                    })
                }
            }
            ...
            function o(e) {
                ...
                var t = r.dom.getParent(r.selection.getStart(), r.dom.isBlock),
                    o = r.settings.forced_root_block,
                    a;
                o && (a = r.dom.createHTML(o, r.settings.forced_root_block_attrs), a = a.substr(0, a.length - 3) + ">"), t && /^(PRE|DIV)$/.test(t.nodeName) || !o ? e = n.filter(e, [
                    ...
                    [/^(.*<\/p>)(<p>)$/, a + "$1"],
                    [/\n/g, "<br />"]
                ]), -1 != e.indexOf("<p>") && (e = a + e)), i(e)
            }

            function a() {
                var t = r.dom,
                    n = r.getBody(),
                    i = r.dom.getViewPort(r.getWin()),
                    o = i.y,
                    a = 20,
                    s;
                if (b = r.selection.getRng(), r.inline && (s = r.selection.getScrollContainer(), s && s.scrollTop > 0 && (o = s.scrollTop)), b.getClientRects) {
                    ...
                    if (l.length) a = o + (l[0].top - t.getPos(n).y);
                    else {
                        a = o;
            ...
            function u(e, t) {
                function n(n) {
                    ...
                    if (n)
                        for (a = 0; a < n.length; a++)
                            if (s = n[a], /^image\/(jpeg|png|gif)$/.test(s.type)) return l = new FileReader, l.onload = o, l.readAsDataURL(s.getAsFile ? s.getAsFile() : s), e.preventDefault(), !0
                }
            ...
            function g() {
                r.on("keydown", function (t) {
                    ...
                    if (h(t) && !t.isDefaultPrevented()) {
                        ...
                        if (t.stopImmediatePropagation(), C = (new Date).getTime(), e.ie && w) return t.preventDefault(), void r.fire("paste", {
                            ieFake: !0
                        });
                    ...
                    var c = d(t),
                        p = (new Date).getTime() - C < 1e3,
                        h = "text" == v.pasteFormat || w;
                    return w = !1, t.isDefaultPrevented() || f(t) ? void s() : u(t) ? void s() : (p || t.preventDefault(), !e.ie || p && !t.ieFake || (a(), r.dom.bind(y, "paste", function (e) {
                        e.stopPropagation()
                    ...
                    var t = p(e);
                    if (!e.isDefaultPrevented() && !u(e, t) && t) {
                        var n = c(e.dataTransfer),
                            a = n["mce-internal"] || n["text/html"] || n["text/plain"];
                    ...
                    if (r.settings.paste_data_images && n)
                        for (t = 0; t < n.types.length; t++)
                            if ("Files" == n.types[t]) return e.preventDefault(), !1
                })
            }
            var v = this,
                y, b, C = 0,
            ...
            v.pasteHtml = i, v.pasteText = o, r.on("preInit", function () {
                g(), r.parser.addNodeFilter("img", function (t) {
                    if (!r.settings.paste_data_images)
        ...
        function s(s) {
            ...
            s.on("BeforePastePreProcess", function (c) {
                ...
                if (p = l.paste_retain_style_properties, p && (m = e.makeMap(p.split(/[, ]/))), l.paste_enable_default_filters !== !1 && a(c.content)) {
                    c.wordContent = !0, f = o.filter(f, [/<!--[\s\S]+?-->/gi, /<(!|script[^>]*>.*?<\/script(?=[>\s])|\/?(\?xml(:\w+)?|img|meta|link|style|\w:\w+)(?=[\s\/>]))[^>]*>/gi, [/<(\/?)s>/gi, "<$1strike>"],
                        [/&nbsp;/gi, "\xa0"],
                    ...
                    v.addAttributeFilter("style", function (e) {
                        ...
                        for (var t = e.length, n, r, i; t--;)
                            if (n = e[t], r = n.attr("href"), i = n.attr("name"), r && -1 != r.indexOf("#_msocom_")) n.remove();
                            else if (r && 0 === r.indexOf("file://") && (r = r.split("#")[1], r && (r = "#" + r)), r || i) {
    ...
    e.addCommand("mcePreview", function () {
        e.windowManager.open({
            ...
            onPostRender: function () {
                ...
                var r = t.body_id || "tinymce"; - 1 != r.indexOf("=") && (r = e.getParam("body_id", "", "hash"), r = r[e.id] || r);
                var d = t.body_class || ""; - 1 != d.indexOf("=") && (d = e.getParam("body_class", "", "hash"), d = d[e.id] || "");
                var o = e.settings.directionality ? ' dir="' + e.settings.directionality + '"' : "";
                if (n = "<!DOCTYPE html><html><head>" + a + '</head><body id="' + r + '" class="mce-content-body ' + d + '"' + o + ">" + e.getContent() + "</body></html>", i) this.getEl("body").firstChild.src = "data:text/html;charset=utf-8," + encodeURIComponent(n);
                else {
...
tinymce.PluginManager.add("save", function (e) {
    function a() {
        var a;
        return a = tinymce.DOM.getParent(e.id, "form"), !e.getParam("save_enablewhendirty", !0) || e.isDirty() ? (tinymce.triggerSave(), e.getParam("save_onsavecallback") ? void(e.execCallback("save_onsavecallback", e) && (e.startContent = tinymce.trim(e.getContent({
            format: "raw"
        })), e.nodeChanged())) : void(a ? (e.isNotDirty = !0, (!a.onsubmit || a.onsubmit()) && ("function" == typeof a.submit ? a.submit() : e.windowManager.alert("Error: Form submit field collision.")), e.nodeChanged()) : e.windowManager.alert("Error: No form element found."))) : void 0
    }
...
! function () {
    function e(e, t, n, a, r) {
        ...
        function d(e) {
            ...
            if (t = "", (u[e.nodeName] || m[e.nodeName]) && (t += "\n"), e = e.firstChild)
                do t += d(e); while (e = e.nextSibling);
            return t
        }
        ...
        if (f = t.ownerDocument, u = r.getBlockElements(), h = r.getWhiteSpaceElements(), m = r.getShortEndedElements(), s = d(t)) {
            if (e.global)
                for (; c = e.exec(s);) g.push(i(c, a));
            else c = s.match(e), g.push(i(c, a));
    ...
    function t(t) {
        ...
        function r(n) {
            var a, r;
            return r = t.dom.create("span", {
                "data-mce-bogus": 1
            }), r.className = "mce-match-marker", a = t.getBody(), c.done(!1), e(n, a, r, !1, t.schema)
        }
...
! function (e, t) {
    ...
    var s = {},
        l = "tinymce/spellcheckerplugin/DomTextMatcher",
        c = "tinymce/spellcheckerplugin/Plugin",
        d = "tinymce/PluginManager",
        u = "tinymce/util/Tools",
        f = "tinymce/ui/Menu",
        p = "tinymce/dom/DOMUtils",
        m = "tinymce/util/XHR",
        h = "tinymce/util/URI",
        g = "tinymce/util/JSON";
    r(l, [], function () {
        return function (e, t) {
            ...
            function r(e) {
                ...
                if (t = "", (k[e.nodeName] || E[e.nodeName]) && (t += "\n"), e = e.firstChild)
                    do t += r(e); while (e = e.nextSibling);
                return t
            }
            ...
            function i(e, t, n) {
                ...
                e: for (;;) {
                    if ((k[c.nodeName] || E[c.nodeName]) && l++, 3 === c.nodeType && (!i && c.length + l >= d.end ? (i = c, a = d.end - l) : r && s.push(c), !r && c.length + l > d.start && (r = c, o = d.start - l), l += c.length), r && i) {
                        if (c = n({
                            startNode: r,
                            startNodeIndex: o,
                            endNode: i,
            ...
            function o(e) {
                ...
                return function (e) {
                    ...
                    if (o === a) {
                        ...
                        var d = t(e.match, s);
                        return i.insertBefore(d, c), e.endNodeIndex < c.length && (r = l.createTextNode(c.data.substring(e.endNodeIndex)), i.insertBefore(r, c)), c.parentNode.removeChild(c), d
                    }
                    n = l.createTextNode(o.data.substring(0, e.startNodeIndex)), r = l.createTextNode(a.data.substring(e.endNodeIndex));
                    for (var u = t(o.data.substring(e.startNodeIndex), s), f = [], p = 0, m = e.innerNodes.length; m > p; ++p) {
    ...
    }), r(c, [l, d, u, f, p, m, h, g], function (e, t, n, r, i, o, a, s) {
        t.add("spellchecker", function (t, l) {
            function c() {
                return N.textMatcher || (N.textMatcher = new e(t.getBody(), t)), N.textMatcher
            }
            ...
            function f(e, o) {
                ...
                var l = i.DOM.getPos(t.getContentAreaContainer()),
                    c = t.dom.getPos(o[0]),
                    d = t.dom.getRoot();
                "BODY" == d.nodeName ? (c.x -= d.ownerDocument.documentElement.scrollLeft || d.scrollLeft, c.y -= d.ownerDocument.documentElement.scrollTop || d.scrollTop) : (c.x -= d.scrollLeft, c.y -= d.scrollTop), l.x += c.x, l.y += c.y, T.moveTo(l.x, l.y + o[0].offsetHeight)
            }
            ...
            function m(e, t, r, i) {
                var c = {
                    ...
                    d = "";
                "spellcheck" == e && (c.text = t, c.lang = R.spellchecker_language), "addToDictionary" == e && (c.word = t), n.each(c, function (e, t) {
                    d && (d += "&"), d += t + "=" + encodeURIComponent(e)
                }), o.send({
                    url: new a(l).toAbsolute(R.spellchecker_rpc_url),
                    type: "post",
            ...
            function h(e, t, n, r) {
                var i = R.spellchecker_callback || m;
                i.call(N, e, t, n, r)
            }
            ...
            function g() {
                function e(e) {
                    var n;
                    return e.words ? (A = !!e.dictionary, n = e.words) : n = e, t.setProgressState(!1), u(n) ? (t.windowManager.alert("No misspellings found"), void(S = !1)) : (E = n, c().find(p()).filter(function (e) {
                        return !!n[e.text]
                    }).wrap(function (e) {
                ...
                return S ? void C() : (C(), S = !0, t.setProgressState(!0), h("spellcheck", c().text, e, n), void t.focus())
            }
            ...
            function C() {
                c().reset(), N.textMatcher = null, S && (S = !1, t.fire("SpellcheckEnd"))
            }
            ...
            function w(e) {
                var r, i = [];
                if (r = n.toArray(t.getBody().getElementsByTagName("span")), r.length)
            ...
            var k, N = this,
                E, S, T, R = t.settings,
                A, B = R.spellchecker_languages || "English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr_FR,German=de,Italian=it,Polish=pl,Portuguese=pt_BR,Spanish=es,Swedish=sv";
            k = d("Language", n.map(B.split(","), function (e) {
                var t = e.split("=");
                return {
                    name: t[0],
                    value: t[1]
            ...
            k.length > 1 && (D.type = "splitbutton", D.menu = k, D.onshow = _, D.onselect = function (e) {
                R.spellchecker_language = e.control.settings.data
            }), t.addButton("spellchecker", D), t.addCommand("mceSpellCheck", g), t.on("remove", function () {
                T && (T.remove(), T = null)
            }), t.on("change", v), this.getTextMatcher = c, this.getWordCharPattern = p, this.getLanguage = function () {
                return R.spellchecker_language
            }, R.spellchecker_language = R.spellchecker_language || R.language || "en"
        })
    }), a([l])
}(this);
    ...
    function t(n) {
        function t(n) {
            ...
            if (u = i.select(":input:enabled,*[tabindex]:not(iframe)"), o(u, function (n, t) {
                ...
                for (d = a + 1; d < u.length; d++)
                    if (c(u[d])) return u[d]
            } else
                for (d = a - 1; d >= 0; d--)
                    if (c(u[d])) return u[d]; return null
        }
        var a, u, c, d;
...
! function (e, t) {
    ...
    var s = {},
        l = "tinymce/tableplugin/TableGrid",
        c = "tinymce/util/Tools",
        d = "tinymce/Env",
        u = "tinymce/tableplugin/Quirks",
        f = "tinymce/util/VK",
        p = "tinymce/tableplugin/CellSelection",
        m = "tinymce/dom/TreeWalker",
        h = "tinymce/tableplugin/Dialogs",
        g = "tinymce/tableplugin/Plugin",
        v = "tinymce/PluginManager";
    r(l, [c, d], function (e, n) {
        ...
        return function (o, a) {
                ...
                B = [], D = 0, i(["thead", "tbody", "tfoot"], function (t) {
                    ...
                    i(n, function (n, o) {
                        o += e, i(O.select("> td, > th", n), function (e, n) {
                            ...
                            if (B[o])
                                for (; B[o][n];) n++;
                            for (s = r(e, "rowspan"), l = r(e, "colspan"), a = o; o + s > a; a++)
                                for (B[a] || (B[a] = []), i = n; n + l > i; i++) B[a][i] = {
                                    part: t,
                                    real: a == o && i == n,
                                    elm: e,
                                    rowspan: s,
            ...
            function u(e) {
                return e && (O.hasClass(e.elm, "mce-item-selected") || e == L)
            }
            ...
            function f() {
                ...
                return i(a.rows, function (t) {
                    i(t.cells, function (n) {
                        return O.hasClass(n, "mce-item-selected") || L && n == L.elm ? (e.push(t), !1) : void 0
                    })
                }), e
            }
            ...
            function p() {
                var e = O.createRng();
                e.setStartAfter(a), e.setEndAfter(a), H.setRng(e), O.remove(a)
            }
            ...
            function m(t) {
                ...
                }, "childNodes"), t = l(t, !1), d(t, "rowSpan", 1), d(t, "colSpan", 1), r ? t.appendChild(r) : (!n.ie || n.ie > 10) && (t.innerHTML = '<br data-mce-bogus="1" />'), t
            }
            ...
            function h() {
                ...
                }), 0 === O.select("tr", a).length ? (e.setStartBefore(a), e.setEndBefore(a), H.setRng(e), void O.remove(a)) : (i(O.select("thead,tbody,tfoot", a), function (e) {
                    0 === e.rows.length && O.remove(e)
                }), s(), void(P && (t = B[Math.min(B.length - 1, P.y)], t && (H.select(t[Math.min(t.length - 1, P.x)].elm, !0), H.collapse(!0)))))
            }

            function g(e, t, n, r) {
                var i, o, a, s, l;
                for (i = B[t][e].elm.parentNode, a = 1; n >= a; a++)
                    if (i = O.getNext(i, "tr")) {
                        for (o = e; o >= 0; o--)
                            if (l = B[t + a][o].elm, l.parentNode == i) {
                                for (s = 1; r >= s; s++) O.insertAfter(m(l), l);
                                break
                            }
                        if (-1 == o)
                            for (s = 1; r >= s; s++) i.insertBefore(m(i.cells[0]), i.cells[0])
                    }
            }
                ...
                i(B, function (e, t) {
                    i(e, function (e, n) {
                        ...
                        if (u(e) && (e = e.elm, i = r(e, "colspan"), o = r(e, "rowspan"), i > 1 || o > 1)) {
                            for (d(e, "rowSpan", 1), d(e, "colSpan", 1), a = 0; i - 1 > a; a++) O.insertAfter(m(e), e);
                            g(n, t, o - 1, i)
                        }
                    })
                })
            ...
            function y(t, n, r) {
                ...
                if (t ? (o = E(t), a = o.x, l = o.y, f = a + (n - 1), p = l + (r - 1)) : (P = M = null, i(B, function (e, t) {
                    i(e, function (e, n) {
                        u(e) && (P || (P = {
                            x: n,
                            y: t
                    ...
                    for (v(), s(), y = c(a, l).elm, d(y, "colSpan", f - a + 1), d(y, "rowSpan", p - l + 1), g = l; p >= g; g++)
                        for (m = a; f >= m; m++) B[g] && B[g][m] && (t = B[g][m].elm, t != y && (C = e.grep(t.childNodes), i(C, function (e) {
                            y.appendChild(e)
            ...
            function b(e) {
                ...
                if (i(B, function (t, r) {
                    ...
                    for (s = 0; s < B[0].length; s++)
                        if (B[n][s] && (o = B[n][s].elm, o != a)) {
                            if (e) {
                            ...
                            p = m(o), d(p, "colSpan", o.colSpan), f.appendChild(p), a = o
                        }
            ...
            function C(e) {
                ...
                i(B, function (n) {
                    ...
                    var a, s, l;
                    i[t] && (a = i[t].elm, a != n && (l = r(a, "colspan"), s = r(a, "rowspan"), 1 == l ? e ? (a.parentNode.insertBefore(m(a), a), g(t, o, s - 1, l)) : (O.insertAfter(m(a), a), g(t, o, s - 1, l)) : d(a, "colSpan", a.colSpan + 1), n = a))
                })
            }
            ...
            function x() {
                ...
                i(B, function (n) {
                    i(n, function (n, o) {
                        u(n) && -1 === e.inArray(t, o) && (i(B, function (e) {
                            var t = e[o].elm,
                                n;
                            n = r(t, "colSpan"), n > 1 ? d(t, "colSpan", n - 1) : O.remove(t)
                        }), t.push(o))
                    })
                }), h()
            }
            ...
            function w() {
                function e(e) {
                    ...
                    i(e.cells, function (e) {
                        var n = r(e, "rowSpan");
                        n > 1 && (d(e, "rowSpan", n - 1), t = E(e), g(t.x, t.y, 1, 1))
                    }), t = E(e.cells[0]), i(B[t.y], function (e) {
                        var t;
                        e = e.elm, e != n && (t = r(e, "rowSpan"), 1 >= t ? O.remove(e) : d(e, "rowSpan", t - 1), n = e)
                    })
                }
                var t;
            ...
            function T() {
                ...
                return e = t = 0, i(B, function (n, r) {
                    i(n, function (n, i) {
                        var o, a;
                        u(n) && (n = B[r][i], i > e && (e = i), r > t && (t = r), n.real && (o = n.colspan - 1, a = n.rowspan - 1, o && i + o > e && (e = i + o), a && r + a > t && (t = r + a)))
                    })
                }), {
                    x: e,
                    y: t
            ...
            function R(e) {
                ...
                if (M = E(e), P && M) {
                    for (t = Math.min(P.x, M.x), n = Math.min(P.y, M.y), r = Math.max(P.x, M.x), i = Math.max(P.y, M.y), o = r, a = i, d = n; a >= d; d++) e = B[d][t], e.real || t - (e.colspan - 1) < t && (t -= e.colspan - 1);
                    for (c = t; o >= c; c++) e = B[n][c], e.real || n - (e.rowspan - 1) < n && (n -= e.rowspan - 1);
                    for (d = n; i >= d; d++)
                        for (c = t; r >= c; c++) e = B[d][c], e.real && (s = e.colspan - 1, l = e.rowspan - 1, s && c + s > o && (o = c + s), l && d + l > a && (a = d + l));
                    for (O.removeClass(O.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"), d = n; a >= d; d++)
                        for (c = t; o >= c; c++) B[d][c] && O.addClass(B[d][c].elm, "mce-item-selected")
                }
            }
            ...
            function A(e, t) {
                ...
                do {
                    ...
                    if (i.elm != e) return H.select(i.elm, !0), O.isEmpty(i.elm) && H.collapse(!0), !0
                } while (i.elm == e);
                return !1
            }
            var B, D, P, M, L, H = o.selection,
                O = H.dom;
            a = a || O.getParent(H.getStart(), "table"), s(), L = O.getParent(H.getStart(), "th,td"), L && (P = E(L), M = T(), L = c(P.x, P.y)), e.extend(this, {
                deleteTable: p,
                split: v,
                merge: y,
                insertRow: b,
        ...
        return function (n) {
                ...
                function t(t) {
                    function o(e, r) {
                        var i = e ? "previousSibling" : "nextSibling",
                            o = n.dom.getParent(r, "tr"),
                            s = o[i];
                        if (s) return g(n, r, s, e), t.preventDefault(), !0;
                        var d = n.dom.getParent(o, "table"),
                            u = o.parentNode,
                    ...
                    function g(e, t, r, i) {
                        var o = m(n.dom.getParent(t, "td,th")),
                            a = h(r, o),
                            s = r.childNodes[a],
                            l = d(s, i);
                        u(l || s)
                    ...
                    function v(e) {
                        var t = n.selection.getNode(),
                            r = n.dom.getParent(t, "td,th"),
                            i = n.dom.getParent(e, "td,th");
                        return r && r !== i && y(r, i)
                    }
            ...
            function s() {
                n.on("KeyDown SetContent VisualAid", function () {
                    ...
                    e && "TABLE" == e.nodeName && (n.settings.forced_root_block ? n.dom.add(n.getBody(), n.settings.forced_root_block, n.settings.forced_root_block_attrs, t.ie && t.ie < 11 ? "&nbsp;" : '<br data-mce-bogus="1" />') : n.dom.add(n.getBody(), "br", {
                        "data-mce-bogus": "1"
                    }))
            ...
            function l() {
                function e(e, t, n, r) {
                    var i = 3,
                        o = e.dom.getParent(t.startContainer, "TABLE"),
                        a, s, l;
                ...
                function t() {
                    var t = n.selection.getRng(),
                        r = n.selection.getNode(),
                        i = n.dom.getParent(t.startContainer, "TD,TH");
                    if (e(n, t, r, i)) {
                        i || (i = r);
            ...
            function c() {
                n.on("keydown", function (t) {
                    if ((t.keyCode == e.DELETE || t.keyCode == e.BACKSPACE) && !t.isDefaultPrevented()) {
                        ...
                        if (r) {
                            for (var i = n.dom.select("td,th", r), o = i.length; o--;)
                                if (!n.dom.hasClass(i[o], "mce-item-selected")) return;
        ...
        return function (r) {
            ...
            return r.on("MouseDown", function (e) {
                ...
                if (l) {
                    if (s && (r.getBody().style.webkitUserSelect = ""), d = a.select("td.mce-item-selected,th.mce-item-selected"), d.length > 0) {
                        i = a.createRng(), f = d[0], i.setStartBefore(f), i.setEndAfter(f), e(f, 1), u = new t(f, a.getParent(d[0], "table"));
                        do
            ...
            }), r.on("KeyUp Drop", function () {
                i(), l = s = c = null
            }), {
                clear: i
            }
        }
    }), r(h, [c, d], function (e, t) {
        var n = e.each;
        return function (r) {
            function i() {
                var e = this,
                    t = r.settings.color_picker_callback;
                t && t.call(r, function (t) {
                    e.value(t).fire("change")
                }, e.value())
            }
            ...
            function o(e) {
                return {
                    ...
                    defaults: {
                        onchange: function () {
                            u(e, this.parents().reverse()[0], "style" == this.name())
                        }
                    },
                    items: [{
                        label: "Style",
            ...
            p.tableProps = function () {
                ...
                function c() {
                    var n;
                    u(p, this), y = e.extend(y, this.toJSON()), e.each("backgroundColor borderColor".split(" "), function (e) {
                        delete y[e]
                        ...
                        m || (m = r.plugins.table.insertTable(y.cols || 1, y.rows || 1)), r.dom.setAttribs(m, {
                            ...
                            width: s(y.width),
                            height: s(y.height)
                        }), n = p.select("caption", m)[0], n && !y.caption && p.remove(n), !n && y.caption && (n = p.create("caption"), n.innerHTML = t.ie ? "\xa0" : '<br data-mce-bogus="1"/>', m.insertBefore(n, m.firstChild)), l(m), y.align && r.formatter.apply("align" + y.align, {}, m), r.focus(), r.addVisual()
                    })
                }
                var p = r.dom,
                    m, h, g, v, y = {},
                ...
                i === !0 ? (m = p.getParent(r.selection.getStart(), "table"), m && (y = {
                    ...
                    type: "listbox",
                    label: "Class",
                    values: d(r.settings.table_class_list, function (e) {
                        e.value && (e.textStyle = function () {
                ...
                }, r.settings.table_adv_tab !== !1 ? (f(p, y, m), r.windowManager.open({
                ...
                function t() {
                    u(i, this), m = e.extend(m, this.toJSON()), r.undoManager.transact(function () {
                        n(g, function (e) {
                            r.dom.setAttribs(e, {
                                scope: m.scope,
                                style: m.style,
                ...
                if (g = r.dom.select("td.mce-item-selected,th.mce-item-selected"), p = r.dom.getParent(r.selection.getStart(), "td,th"), !g.length && p && g.push(p), p = p || g[0]) {
                    m = {
                        ...
                        type: "listbox",
                        label: "Class",
                        values: d(r.settings.table_cell_class_list, function (e) {
                            e.value && (e.textStyle = function () {
                                return r.formatter.getCssText({
                                    block: "td",
                                    classes: [e.value]
                    ...
                    r.settings.table_cell_adv_tab !== !1 ? (f(i, m, p), r.windowManager.open({
                ...
                function t() {
                    var t, o, a;
                    u(i, this), g = e.extend(g, this.toJSON()), r.undoManager.transact(function () {
                        var e = g.type;
                        n(v, function (n) {
                            r.dom.setAttribs(n, {
                                scope: g.scope,
                                ...
                                height: s(g.height)
                            }), e != n.parentNode.nodeName.toLowerCase() && (t = i.getParent(n, "table"), o = n.parentNode, a = i.select(e, t)[0], a || (a = i.create(e), t.firstChild ? t.insertBefore(a, t.firstChild) : t.appendChild(a)), a.appendChild(n), o.hasChildNodes() || i.remove(o)), l(n), g.align && r.formatter.apply("align" + g.align, {}, n)
                        }), r.focus()
                    })
                }
                var i = r.dom,
                ...
                c = r.dom.getParent(r.selection.getStart(), "table"), p = r.dom.getParent(r.selection.getStart(), "td,th"), n(c.rows, function (e) {
                    ...
                    type: "listbox",
                    label: "Class",
                    values: d(r.settings.table_row_class_list, function (e) {
                        e.value && (e.textStyle = function () {
                            return r.formatter.getCssText({
                                block: "tr",
                                classes: [e.value]
                ...
                }, r.settings.table_row_adv_tab !== !1 ? (f(i, g, m), r.windowManager.open({
    ...
    }), r(g, [l, u, p, h, c, m, d, v], function (e, t, n, r, i, o, a, s) {
        function l(i) {
            function o(e) {
                return function () {
                    i.execCommand(e)
            ...
            function p(e, t, n) {
                var r = n.getEl().getElementsByTagName("table")[0],
                    o, a, s, l, c, d = n.isRtl() || "tl-tr" == n.parent().rel;
                for (r.nextSibling.innerHTML = e + 1 + " x " + (t + 1), d && (e = 9 - e), a = 0; 10 > a; a++)
                    for (o = 0; 10 > o; o++) l = r.rows[a].childNodes[o].firstChild, c = (d ? o >= e : e >= o) && t >= a, i.dom.toggleClass(l, "mce-active", c), c && (s = l);
                return s.parentNode
            }
            var m, h = this,
                g = new r(i);
            i.settings.table_grid === !1 ? i.addMenuItem("inserttable", {
                ...
                menu: [{
                    ...
                    onclick: o("mceTablePasteRowAfter"),
                    onPostRender: u
                }]
            ...
            c("inserttable tableprops deletetable | cell row column".split(" "), function (e) {
                ...
                mceInsertTable: g.table,
                mceTableProps: function () {
                    g.table(!0)
                },
                mceTableRowProps: g.row,
                mceTableCellProps: g.cell
            }, function (e, t) {
...
tinymce.PluginManager.add("textcolor", function (t) {
    ...
    function r() {
        function e(t, e) {
            var o = "transparent" == t;
            return '<td class="mce-grid-cell' + (o ? " mce-colorbtn-trans" : "") + '"><div id="' + F + "-" + m+++'" data-mce-color="' + (t ? t : "") + '" role="option" tabIndex="-1" style="' + (t ? "background-color: " + t : "") + '" title="' + e + '">' + (o ? "&#215;" : "") + "</div></td>"
        }
        var r, l, a, n, c, d, u, g = this,
            F = g._id,
            m = 0;
        for (r = o(), r.push({
            text: "No color",
        ...
        if (t.settings.color_picker_callback) {
            for (a += '<tr><td colspan="' + i + '" class="mce-custom-color-btn"><div id="' + F + '-c" class="mce-widget mce-btn mce-btn-small mce-btn-flat" role="button" tabindex="-1" aria-labelledby="' + F + '-c" style="width: 100%"><button type="button" role="presentation" tabindex="-1">Custom...</button></div></td></tr>', a += "<tr>", c = 0; i > c; c++) a += e("", "Custom color");
            a += "</tr>"
        }
    ...
    function n(o) {
        ...
        if (tinymce.DOM.getParent(o.target, ".mce-custom-color-btn") && (s.hidePanel(), t.settings.color_picker_callback.call(t, function (t) {
            ...
            if (l == i)
                for (l = 0; i - 1 > l; l++) n(e[l], e[l + 1].getAttribute("data-mce-color"));
            n(o, t), r(t)
...
tinymce.PluginManager.add("textpattern", function (t) {
    ...
    function n(t) {
        for (var n = e(), a = 0; a < n.length; a++)
            if (0 === t.indexOf(n[a].start) && (!n[a].end || t.lastIndexOf(n[a].end) == t.length - n[a].end.length)) return n[a]
    }

    function a(t, n, a) {
        var r, s, d;
        for (r = e(), d = 0; d < r.length; d++)
            if (s = r[d], s.end && t.substr(n - s.end.length - a, s.end.length) == s.end) return s
    }
    ...
    function s() {
        ...
        if (e = t.selection, a = t.dom, e.isCollapsed() && (i = a.getParent(e.getStart(), "p"))) {
            for (f = new tinymce.dom.TreeWalker(i, i); d = f.next();)
                if (3 == d.nodeType) {
                    s = d;
                    break
                }
    ...
    var i, l = !0;
    i = t.settings.textpattern_patterns || [{
        start: "*",
        end: "*",
        format: "italic"
    }, {
...
tinymce.PluginManager.add("visualchars", function (e) {
    function a(a) {
        var t, s, i, r, c, d, l = e.getBody(),
            m = e.selection;
        if (n = !n, o.state = n, e.fire("VisualChars", {
            state: n
        }), a && (d = m.getBookmark()), n)
            for (s = [], tinymce.walk(l, function (e) {
                ...
                for (s = e.dom.select("span.mce-nbsp", l), i = s.length - 1; i >= 0; i--) e.dom.remove(s[i], 1);
        m.moveToBookmark(d)
    }
    ...
    function t() {
        function t(t) {
            ...
            if (t) return d(t.split(/[ ,]/), function (t) {
                ...
                "|" == t ? n = null : c.has(t) ? (t = {
                    type: t
                }, u.toolbar_items_size && (t.size = u.toolbar_items_size), o.push(t), n = null) : (n || (n = {
                    type: "buttongroup",
                    items: []
        ...
        function i(i) {
            ...
            if (s = tinymce.makeMap((u.removed_menuitems || "").split(/[ ,]/)), u.menu ? (o = u.menu[i], a = !0) : o = h[i], o) {
                n = {
                    ...
                    e.context == i && ("before" == e.separator && r.push({
                        text: "|"
